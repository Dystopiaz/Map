...
import nwpu.cs.com.map.overlaytuil.BikingRouteOverlay;
import nwpu.cs.com.map.overlaytuil.DrivingRouteOverlay;
import nwpu.cs.com.map.overlaytuil.MassTransitRouteOverlay;
import nwpu.cs.com.map.overlaytuil.OverlayManager;
import nwpu.cs.com.map.overlaytuil.TransitRouteOverlay;
import nwpu.cs.com.map.overlaytuil.WalkingRouteOverlay;

/**
 * 此demo用来展示如何进行驾车、步行、公交、骑行、跨城综合路线搜索并在地图使用RouteOverlay、TransitOverlay绘制
 * 同时展示如何进行节点浏览并弹出泡泡
 */
public class Path extends Activity implements BaiduMap.OnMapClickListener,
    ...
    private EditText endpoint = null;
    // 搜索相关
    ...
    private String startNodeStr = null;
    private String endNodeStr = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startpoint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Path.this,Search.class);
                intent.putExtra("bdlocation_data",bdLocation);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK){
            switch (requestCode) {
                case 1:
                    String startnode = data.getStringExtra("search_target");
                    startpoint.setText(startnode.toCharArray(), 0, startnode.length());
                    break;
                case 2:
                    String endnode = data.getStringExtra("search_target");
                    endpoint.setText(endnode.toCharArray(),0,endnode.length());
                    break;
                default:
                    break;
            }
...
//
    ...
    public void nodeClick(View v) {
        ...
        // show popup
        popupText = new TextView(Path.this);
    ...
    public void onGetWalkingRouteResult(WalkingRouteResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(Path.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
        }
        ...
        if (result.error == SearchResult.ERRORNO.NO_ERROR) {
            ...
            if (result.getRouteLines().size() > 1 ) {
                ...
                MyTransitDlg myTransitDlg = new MyTransitDlg(Path.this,
